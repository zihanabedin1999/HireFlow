...
exports.CustomDatabaseService = void 0;
...
class CustomDatabaseService {
    ...
    initializeSampleData() {
        ...
        logger_1.default.info(`Initialized custom database with ${this.candidates.length} sample candidates`);
    }
    async searchCandidates(jobDescription) {
        ...
        logger_1.default.info(`Found ${matchingCandidates.length} candidates with 20%+ match for job: ${jobDescription.title}`);
        return matchingCandidates.map(item => item.candidate);
    }
    calculateMatchScore(candidate, jobDescription) {
        const skillKeywords = [
    ...
    async addCandidate(candidate) {
        ...
        logger_1.default.info(`Added new candidate: ${candidate.name}`);
    }
...
exports.CustomDatabaseService = CustomDatabaseService;
exports.default = new CustomDatabaseService();
//# sourceMappingURL=custom-database.js.map